...
import { t as Route$23 } from "./ngo.dashboard-C5-FWAWA.mjs";
import { r as getGoogleAi, t as DEFAULT_CHAT_MODEL } from "./ai-gateway.server-Bqa6mA37.mjs";
import { t as Route$24 } from "./jobs._id-BfJH-d4S.mjs";
import { t as Route$25 } from "./mentor._threadId-VX9L5y4N.mjs";
import { t as Route$26 } from "./ngo.survivors._id-DiTSOjnW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CxbqAeZH.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CAlCOsal.css";
...
var $$splitComponentImporter$17 = () => import("./onboarding-CfqWC3U4.mjs");
var Route$21 = createFileRoute("/onboarding")({
	head: () => ({ meta: [{ title: "Get started · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$17, "component")
});
var $$splitComponentImporter$16 = () => import("./auth-BT_4rGWz.mjs");
...
var $$splitComponentImporter$15 = () => import("./routes-CSbfvmew.mjs");
...
var Route$18 = createFileRoute("/recruiter/")({ beforeLoad: () => {
	throw redirect({ to: "/recruiter/search" });
} });
var Route$17 = createFileRoute("/ngo/")({ beforeLoad: () => {
	throw redirect({ to: "/ngo/dashboard" });
} });
var $$splitComponentImporter$14 = () => import("./mentor.index-BMfXN7In.mjs");
var Route$16 = createFileRoute("/mentor/")({
	head: () => ({ meta: [{ title: "AI Mentor · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$14, "component")
});
var $$splitComponentImporter$13 = () => import("./jobs.index-CqbIt94j.mjs");
...
var Route$14 = createFileRoute("/admin/")({ beforeLoad: () => {
	throw redirect({ to: "/admin/dashboard" });
} });
var $$splitComponentImporter$12 = () => import("./settings.notifications-D-1S5sjm.mjs");
var Route$13 = createFileRoute("/settings/notifications")({
	head: () => ({ meta: [{ title: "Notification settings · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$12, "component")
});
var $$splitComponentImporter$11 = () => import("./recruiter.search-CspcaiOc.mjs");
var Route$12 = createFileRoute("/recruiter/search")({
	head: () => ({ meta: [{ title: "Search survivors · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$11, "component")
});
var $$splitComponentImporter$10 = () => import("./recruiter.requests-ClYrRNeT.mjs");
var Route$11 = createFileRoute("/recruiter/requests")({
	head: () => ({ meta: [{ title: "Introduction requests · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$10, "component")
});
var $$splitComponentImporter$9 = () => import("./recruiter.jobs-DldeMH8N.mjs");
var Route$10 = createFileRoute("/recruiter/jobs")({
	head: () => ({ meta: [{ title: "Jobs · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
var $$splitComponentImporter$8 = () => import("./recruiter.analytics-DRWRf1R8.mjs");
var Route$9 = createFileRoute("/recruiter/analytics")({
	head: () => ({ meta: [{ title: "Analytics · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
var $$splitComponentImporter$7 = () => import("./ngo.survivors-D-qboHr-.mjs");
var Route$8 = createFileRoute("/ngo/survivors")({
	head: () => ({ meta: [{ title: "Survivors · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
var $$splitComponentImporter$6 = () => import("./ngo.requests-Cf-DPw-R.mjs");
var Route$7 = createFileRoute("/ngo/requests")({
	head: () => ({ meta: [{ title: "Introduction requests · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
var $$splitComponentImporter$5 = () => import("./ngo.organization-MJ8V8fqw.mjs");
var Route$6 = createFileRoute("/ngo/organization")({
	head: () => ({ meta: [{ title: "Organization · CAREVIA" }] }),
	component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
var $$splitComponentImporter$4 = () => import("./ngo.analytics-DeWkYP2q.mjs");
var Route$5 = createFileRoute("/ngo/analytics")({
	head: () => ({ meta: [{ title: "Analytics · CAREVIA" }] }),
...
var RecruiterIndexRoute = Route$18.update({
	id: "/recruiter/",
	path: "/recruiter/",
	getParentRoute: () => Route$22
});
var NgoIndexRoute = Route$17.update({
	id: "/ngo/",
	path: "/ngo/",
	getParentRoute: () => Route$22
});
var MentorIndexRoute = Route$16.update({
	id: "/mentor/",
	path: "/mentor/",
	getParentRoute: () => Route$22
});
var JobsIndexRoute = Route$15.update({
	id: "/jobs/",
	path: "/jobs/",
	getParentRoute: () => Route$22
});
...
var SettingsNotificationsRoute = Route$13.update({
	id: "/settings/notifications",
	path: "/settings/notifications",
	getParentRoute: () => Route$22
});
var RecruiterSearchRoute = Route$12.update({
	id: "/recruiter/search",
	path: "/recruiter/search",
	getParentRoute: () => Route$22
});
var RecruiterRequestsRoute = Route$11.update({
	id: "/recruiter/requests",
	path: "/recruiter/requests",
	getParentRoute: () => Route$22
});
var RecruiterJobsRoute = Route$10.update({
	id: "/recruiter/jobs",
	path: "/recruiter/jobs",
	getParentRoute: () => Route$22
});
var RecruiterAnalyticsRoute = Route$9.update({
	id: "/recruiter/analytics",
	path: "/recruiter/analytics",
	getParentRoute: () => Route$22
});
var NgoSurvivorsRoute = Route$8.update({
	id: "/ngo/survivors",
	path: "/ngo/survivors",
	getParentRoute: () => Route$22
});
var NgoRequestsRoute = Route$7.update({
	id: "/ngo/requests",
	path: "/ngo/requests",
	getParentRoute: () => Route$22
});
var NgoOrganizationRoute = Route$6.update({
	id: "/ngo/organization",
	path: "/ngo/organization",
	getParentRoute: () => Route$22
});
var NgoDashboardRoute = Route$23.update({
	id: "/ngo/dashboard",
	path: "/ngo/dashboard",
	getParentRoute: () => Route$22
});
var NgoAnalyticsRoute = Route$5.update({
	id: "/ngo/analytics",
	path: "/ngo/analytics",
	getParentRoute: () => Route$22
});
var MentorThreadIdRoute = Route$25.update({
	id: "/mentor/$threadId",
	path: "/mentor/$threadId",
	getParentRoute: () => Route$22
});
var JobsIdRoute = Route$24.update({
	id: "/jobs/$id",
	path: "/jobs/$id",
	getParentRoute: () => Route$22
});
...
var NgoSurvivorsRouteChildren = { NgoSurvivorsIdRoute: Route$26.update({
	id: "/$id",
	path: "/$id",
