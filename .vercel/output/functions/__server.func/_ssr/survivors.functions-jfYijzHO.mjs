...
//#region node_modules/.nitro/vite/services/ssr/assets/survivors.functions-jfYijzHO.js
...
async function embedSurvivorInternal(supabase, _userId, survivorId) {
	...
	try {
		const { buildSurvivorEmbedText, embedText } = await import("./ai-gateway.server-Bqa6mA37.mjs").then((n) => n.n);
