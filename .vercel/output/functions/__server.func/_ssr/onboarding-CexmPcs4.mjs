...
import { E as Briefcase, T as Building2, f as LogOut, h as HeartHandshake, s as ShieldCheck } from "../_libs/lucide-react.mjs";
import { t as Textarea } from "./textarea-kko37XEX.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { r as requestAdminSignupRole } from "./admin.functions-Dv_MNoXz.mjs";
import { t as Input } from "./input-B8Q2ztVi.mjs";
import { t as Label } from "./label-DBD1bRRP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/onboarding-CexmPcs4.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
			...
			children: step === "role" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RoleChooser, { onPick: (r) => {
				...
				onBack: () => setStep("role")
			}) : step === "admin" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminSignupForm, {
				onDone: async () => {
...
function AdminSignupForm({ onDone, onBack }) {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Enter your invitation code to verify admin access and unlock the CAREVIA admin dashboard."
				})
			] }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				type: "submit",
				disabled: saving,
				children: saving ? "Verifying…" : "Verify code"
			})
		]
	});
}
