...
//#region node_modules/.nitro/vite/services/ssr/assets/ngo.dashboard-BD-5nUBD.js
...
function DashboardInner() {
	...
	if (ngo.status === "pending") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusBanner, {
		icon: Clock,
		tone: "warning",
