...
//#region node_modules/.nitro/vite/services/ssr/assets/ai-gateway.server-DnPLjrXx.js
...
function getApiKey() {
	const key = process.env.GEMINI_API_KEY ?? process.env.GOOGLE_GENERATIVE_AI_API_KEY ?? process.env.VITE_GEMINI_API_KEY ?? process.env.VITE_GOOGLE_GENERATIVE_AI_API_KEY;
