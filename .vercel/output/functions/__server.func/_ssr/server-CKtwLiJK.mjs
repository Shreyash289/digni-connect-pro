...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DAphGDYW.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-KfCU9o5I.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-yJ5EFVPV.mjs"),
		import("./start-CaLYjMz4.mjs"),
